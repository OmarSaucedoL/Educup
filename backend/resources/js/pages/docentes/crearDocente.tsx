    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <h1 className="text-2xl font-semibold tracking-tight">Registrar Nuevo Docente</h1>
                <div className="border-sidebar-border/70 dark:border-sidebar-border relative flex-1 rounded-xl border p-6 bg-card text-card-foreground shadow-sm">
                    ...
                    <p className="text-muted-foreground">Formulario de asignación de Docente en construcción...</p>
                </div>
            </div>
        </AppLayout>
    );
