...
export default function ReportsIndex({ cup, cups, estudiantes = [], postulantesAprobados = [], estadisticasCarreras = [], distribucionAprobados = [] }: ReportsProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <style dangerouslySetInnerHTML={{__html: `
                @media print {
                    /* Ocultar elementos generales de navegación y barra lateral */
                    aside, header, nav, button, select, input, [data-sidebar="sidebar"], .peer, [data-sidebar="trigger"], .no-print, .print\\:hidden, .print-hidden, .pagination-controls, [role="tablist"] {
