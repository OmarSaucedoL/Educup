...
export default function VerClasesPage({ cup, cupsList = [] }: { cup: any, cupsList?: any[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {/* Dialog de confirmación de asignación automática */}
            ...
            {/* Dialog de confirmación para remover docentes */}
            <Dialog open={showRemoverDialog} onOpenChange={setShowRemoverDialog}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        <Button variant="outline" onClick={() => setShowRemoverDialog(false)}>
                            Cancelar
                        </Button>
                        <Button 
                            variant="destructive"
                            onClick={handleRemoverDocentes}
                        >
